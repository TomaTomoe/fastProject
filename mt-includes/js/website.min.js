        ...
        controller: ["$scope", "$element", function(c, d) {
            function e() {
                try {
                    ...
                    h !== g && (g = h,
                    g ? d.addClass(b.cssVisibleClass) : d.removeClass(b.cssVisibleClass))
                } catch (a) {}
            }
...
angular.module("website.core.dependency").directive("motoDependencyRequire", ["motoDependencyService", function(a) {
    return {
        ...
        link: function(b, c, d) {
            ...
            try {
                f = b.$eval(f),
                angular.isUndefined(f) && (f = e)
            } catch (a) {
                f = e
            }
            angular.isFunction(f) && (f = f()),
            a.require(f)
        }
    }
}
...
angular.module("website.core.dependency").provider("motoDependencyService", ["motoWebsiteSettingsServiceProvider", function(a) {
    ...
    var h = {}
      , i = angular.element("head").get(0)
      , j = angular.element("body").get(0)
      , k = {
        en: "en_US",
        de: "de_DE",
        ru: "ru_RU"
...
angular.module("website.moto_link", []).run(function() {
    ...
    for (a = 0; a < c.length; a++)
        b = $(c[a]),
        b.hasClass("moto-widget-image-link") ? b.magnificPopup({
            type: "image",
            tClose: "",
            tLoading: "",
            zoom: {
...
angular.module("website").directive("motoSticky", ["$window", "$timeout", function(a, b) {
    ...
    function d(a) {
        ...
        return "smallHeight" === a.options.mode ? (b = Math.max(document.documentElement.clientHeight, window.innerHeight || 0),
        d.top + c.outerHeight() < b) : ("top" === a.options.direction && (e = d.top - g <= f),
        e)
    }
    function e(a) {
        var b = 0;
        try {
            ...
            a.options.hidden || a.$pseudoElement.height(a.$element.outerHeight(!0)),
            s && (a.$pseudoElement.hide(),
            a.$element.removeClass(o.attachedClass).removeClass(o.attachedClass + "_" + a.options.direction).removeAttr("style"),
            b = a.$element.innerWidth(),
            a.$pseudoElement.show(),
            a.$element.innerWidth(b),
            a.$pseudoElement.innerWidth(b),
            a.$element.addClass(o.attachedClass).addClass(o.attachedClass + "_" + a.options.direction))
        } catch (a) {
            c() && console.info("motoSticky : ERROR on syncPseudoElement", a)
        }
    }
    function f(a) {
        return a.isAttached || (a.$element.show().addClass(o.attachedClass).addClass(o.attachedClass + "_" + a.options.direction),
        a.isAttached = !0),
        e(a),
        !0
    }
    function g(a) {
        return a.$pseudoElement.width(a.$element.innerWidth()),
        !a.isAttached || (a.$element.css("width", ""),
        a.isAttached = !1,
        a.$element.removeClass(o.attachedClass).removeClass(o.attachedClass + "_" + a.options.direction),
        void (a.options.hidden ? (a.$pseudoElement.height(0),
        a.$element.hide()) : a.$pseudoElement.hide()))
    }
    function h(a) {
        try {
            d(a) ? f(a) : g(a)
    ...
    function j(a) {
        a.$pseudoElement || (a.$pseudoElement = angular.element('<div class="' + o.pseudoElementClass + '"></div>'),
        a.$pseudoElement.insertAfter(a.$element),
        a.options.hidden ? a.$pseudoElement.height(0) : (a.$pseudoElement.hide(),
    ...
    n.scroll(l).resize(l),
    {
        restrict: "A",
        compile: function(a) {
            return a.addClass(o.bootstrappedClass),
            k
        }
    }
}
...
angular.module("moto.validation").directive("motoClearValidationOnChange", function() {
    return {
        ...
        link: function(a, b, c, d) {
            ...
            !f && c.motoClearValidationOnChange && (f = c.motoClearValidationOnChange),
...
angular.module("website.widget.audio_player", ["website.core"]).directive("motoWidgetAudioPlayer", ["$rootScope", function(a) {
    return {
        ...
        link: function(b, c) {
            ...
            !a.isAnyAutoPlayStarted && d.data("autoplay") && (a.isAnyAutoPlayStarted = !0,
            d[0].player.play())
        }
    }
}
]),
angular.module("website.widget.auth_form", ["core.library.jsonrpc", "angularFileUpload"]).service("widget.AuthForm.Service", ["jsonrpc", function(a) {
    ...
    return {
        ...
        link: function(c, d, e) {
            c.request = {
                password: "",
                pageId: e.destinationPageId
            },
            c.submit = function() {
                c.request.pageId && (c.authForm.password.$setTouched(),
                c.authForm.$valid && a.loginToPageByPassword(c.request).success(function() {
                    b.location.reload()
                }).error(function(a) {
...
angular.module("website.widget.contact_form", ["core.library.jsonrpc", "angularFileUpload"]).config(function() {}).run(function() {}).service("widget.ContactForm.Service", ["jsonrpc", function(a) {
    ...
    function f(b) {
        return b.error ? e(b.error) : (a.emailSent = !0,
        a.triedToSend = !1,
        void (a.sending = !1))
    }
    ...
    i.length)
        for (var k = 0, l = i.length; k < l; k++)
            ...
            h = g.attr("name"),
            h && (a.message[h] = a.message[h] || "",
            a.placeholder[h] = g.attr("placeholder") || h);
    a.validateEmailOnBlur = function() {
        if (a.contactForm.email.$pristine = !1,
        "" != a.contactForm.email.$viewValue) {
            var b = j.test(a.contactForm.email.$viewValue);
            b ? (a.contactForm.email.emailInvalid = !1,
            a.contactForm.email.$setValidity("pattern", !0)) : (a.contactForm.email.emailInvalid = !0,
    ...
    a.validateRequiredOnBlur = function(b) {
        ...
        "" == a.contactForm[b].$viewValue ? (a.contactForm[b].$invalid = !0,
        a.contactForm.$valid = !1) : a.contactForm[b].$invalid = !1
    }
    ,
    ...
    a.triedToSend = !1,
    a.submit = function() {
        a.sending || (a.emailSent = !1,
        a.triedToSend = !0,
        a.errors = [],
        a.sending = !0,
        a.emailError = !1,
        "object" == typeof a.contactForm.$error.required ? (a.contactForm.$error.required.forEach(function(a) {
            a.$dirty = !0,
            a.$pristine = !1,
            a.$setTouched()
        }),
        a.contactForm.$valid = !1) : a.contactForm.$valid = !0,
        a.validate("email"),
        a.contactForm && a.contactForm.$valid && !a.contactForm.emailInvalid && (a.attachments.length ? (a.message._attachments = a.attachments.length,
        d.upload({
            method: "POST",
            url: c.getApiPath(),
            file: a.attachments,
    ...
    return {
        ...
        link: function(c, d, e) {
            try {
                ...
                f && f.shortname && "" != f.shortname && a.get("disqus").setParams(f).require()
            } catch (a) {}
        }
    }
}
...
angular.module("website.widget.mail_chimp", ["core.library.jsonrpc"]).service("website.widget.MailChimpService", ["jsonrpc", function(a) {
    ...
    function e(b) {
        a.emailError = !0,
        a.sending = !1,
        b.data && b.data.errors && b.data.errors.detail && (a.isSubscribed = b.data.errors.detail.match(/is already a list member/g))
    }
    ...
    a.validateEmailOnBlur = function() {
        if (a.subscribeForm.email.$pristine = !1,
        "" != a.subscribeForm.email.$viewValue) {
            var b = i.test(a.subscribeForm.email.$viewValue);
            b ? (a.subscribeForm.email.emailInvalid = !1,
            a.subscribeForm.email.$setValidity("pattern", !0)) : (a.subscribeForm.email.emailInvalid = !0,
    ...
    a.validateRequiredOnBlur = function(b) {
        ...
        "" == a.subscribeForm[b].$viewValue ? (a.subscribeForm[b].$invalid = !0,
        a.subscribeForm.$valid = !1) : a.subscribeForm[b].$invalid = !1
    }
    ,
    a.validate = function(b) {
        "email" == b ? (a.validateEmailOnBlur(),
        a.validateRequiredOnBlur(b)) : a.validateRequiredOnBlur(b)
    }
    ,
    a.submit = function() {
        a.sending || (a.emailSent = !1,
        ...
        a.emailError = !1,
        a.isSubscribed = !1,
        "object" == typeof a.subscribeForm.$error.required ? (a.subscribeForm.$error.required.forEach(function(a) {
            a.$dirty = !0,
            a.$pristine = !1,
            a.$setTouched()
        }),
        a.subscribeForm.$valid = !1) : a.subscribeForm.$valid = !0,
        a.validate("email"),
        a.subscribeForm && a.subscribeForm.$valid && !a.subscribeForm.emailInvalid && (a.message.list_id = a.listId || "",
        c.subscribe({
            request: a.message
        }).success(d).error(e)))
    }
...
angular.module("website.widget.twitter.time_line", ["ng"]).directive("motoWidgetTwitterTimeLine", ["motoDependencyService", function(a) {
    return {
        restrict: "AC",
        link: function(b, c, d) {
            try {
    ...
    return {
        ...
        link: function(b, c) {
            ...
            d.on("loadeddata", function() {
                c.removeClass("moto-media-player_not-loaded").addClass("moto-media-player_loaded"),
